...
?>
    ...
    <div class="row">
        ...
        <div class="col-75"><input type="text" name="name" value="<?php echo $_POST['name']; ?>"pattern="[A-Za-z /@]{3,30}" required maxlength="30" > (3-30 Characters, no special characters except / and @)</div>
    </div>
    <div class="row">    
        <div class="col-25"><label>Matrix No:</label></div>
        <div class="col-75"><input type="text" name="matrixNo" value="<?php echo $_POST['matrixNo']; ?>"pattern="[A-Z]{1}[0-9]{9}" placeholder="B123456789"required maxlength="10"></div>
    </div>
    <div class="row">
    ...
    <div class="row" style="float:right;">
        <input type="submit" name="editUserConfirm" value="Edit User">
    </div>
    <br><br>
    </form>
    </div>
